...
# Sun Apr 03 21:39:16 CDT 2022
# DO NOT MODIFY


# 
# VGA_text_mode_controller "VGA Text Mode Controller" v1.0
# Zuofu Cheng 2022.04.03.21:39:16
# 
# 
...
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH Lab7Provided/vga_text_avl_interface.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL vga_text_avl_interface
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH Lab7Provided/vga_text_avl_interface.sv
...
# 
# connection point VGA_port_1_1
# 
add_interface VGA_port_1_1 conduit end
set_interface_property VGA_port_1_1 associatedClock CLK
set_interface_property VGA_port_1_1 associatedReset RESET
set_interface_property VGA_port_1_1 ENABLED true
set_interface_property VGA_port_1_1 EXPORT_OF ""
set_interface_property VGA_port_1_1 PORT_NAME_MAP ""
set_interface_property VGA_port_1_1 CMSIS_SVD_VARIABLES ""
set_interface_property VGA_port_1_1 SVD_ADDRESS_GROUP ""

add_interface_port VGA_port_1_1 vs vs Output 1
add_interface_port VGA_port_1_1 hs hs Output 1
add_interface_port VGA_port_1_1 blue blue Output 4
add_interface_port VGA_port_1_1 green green Output 4
add_interface_port VGA_port_1_1 red red Output 4
