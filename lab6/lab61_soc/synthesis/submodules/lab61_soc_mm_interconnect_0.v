...
`timescale 1 ps / 1 ps
module lab61_soc_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                  //                                clk_0_clk.clk
		input  wire        sdram_pll_c0_clk,                               //                             sdram_pll_c0.clk
		input  wire        key0_reset_reset_bridge_in_reset_reset,         //         key0_reset_reset_bridge_in_reset.reset
	...
	wire  [105:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key0_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [106:0] key1_s1_agent_rf_source_data;                                                       // key1_s1_agent:rf_source_data -> key1_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] key1_s1_agent_rsp_fifo_out_data;                                                    // key1_s1_agent_rsp_fifo:out_data -> key1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> key1_s1_agent:cp_valid
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> key1_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // key1_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> key1_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> key1_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> key1_s1_agent:cp_endofpacket
	...
	wire  [105:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [105:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire          key1_s1_agent_rp_valid;                                                             // key1_s1_agent:rp_valid -> router_010:sink_valid
	wire  [105:0] key1_s1_agent_rp_data;                                                              // key1_s1_agent:rp_data -> router_010:sink_data
	wire          key1_s1_agent_rp_ready;                                                             // router_010:sink_ready -> key1_s1_agent:rp_ready
	wire          key1_s1_agent_rp_startofpacket;                                                     // key1_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          key1_s1_agent_rp_endofpacket;                                                       // key1_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          key1_s1_agent_rdata_fifo_src_valid;                                                 // key1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] key1_s1_agent_rdata_fifo_src_data;                                                  // key1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          key1_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_008:in_0_ready -> key1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> key1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> key1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // key1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> key1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (key0_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (key0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_router router (
	...
	lab61_soc_mm_interconnect_0_router router_001 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_002 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_003 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_004 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_005 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_006 (
	...
	lab61_soc_mm_interconnect_0_router_007 router_007 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_008 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_009 (
	...
	lab61_soc_mm_interconnect_0_router_002 router_010 (
	...
	lab61_soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (key0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61_soc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	lab61_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (key0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
